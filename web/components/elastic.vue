            ...
            async generateFromTrack() {
                ...
                try {
                    ...
                    if (this.trackState.isPlaying) {
                        ...
                        if (offset > track.features.duration_ms) {
