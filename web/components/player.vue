    ...
    <aside>
        <div class="container">
            <div class="wrapper" :class="{deviceMenuVisible: devicesMenu}">
                <menu>
                    <li v-if="!$store.state.preferences.showCompass"><button @click="showCompass(); $ga.event('player', 'toggle-compass')" :class="{disabled: !$store.getters['tracks/playlistLoaded'] || $store.state.loading.playlistGenerating}">
                    ...
                    <li v-if="$store.state.preferences.showCompass"><button @click="showPlaylist(); $ga.event('player', 'toggle-playlist')" class="fillMagenta" :class="{disabled: !$store.getters['tracks/playlistLoaded'] || $store.state.loading.playlistGenerating}">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showCompass() {
                this.$store.commit('preferences/showCompass');
            },
            showPlaylist() {
