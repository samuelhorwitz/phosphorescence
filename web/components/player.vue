<template>
    <aside>
        <div class="container">
            <div class="wrapper" :class="{deviceMenuVisible: devicesMenu}">
                ...
                <div class="trackData" ref="trackData" :class="{stopped: $store.getters['tracks/stopped']}">
                    ...
                    <span class="nothingPlaying scrollingBanner" v-if="$store.getters['tracks/stopped'] && !$store.state.tracks.spotifyAppearsDown">
        ...
        <div v-if="devicesMenu" class="devicesMenu">
            <ol>
                <li v-for="(device, index) in devices" :class="{active: device.active}" @click="transferDevice(device.id)">
                    <button class="deviceButton">
                        ...
                        <div class="deviceName">{{device.name}} <span v-if="index == 0">(This Window)</span></div>
                    </button>
                </li>
