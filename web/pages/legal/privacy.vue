<template>
    <legal>
        ...
        <p>Your privacy is important to us. It is Phosphorescence's policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://phosphor.me">https://phosphor.me</a>, and other sites we own and operate.</p>
        <p>We are not affiliated with Spotify, however we depend on their API and their embedded web player, both of which may collect user data through your usage of our website. Please also refer to <a target="_blank" rel="external noopener" href="https://www.spotify.com/is/legal/privacy-policy/">Spotify's Privacy Policy</a>.</p>
        ...
        <p><strong>Phosphorescence Data Controller</strong><br />
        Samuel Horwitz<br />
        <a href="mailto:data@phosphor.me">data@phosphor.me</a></p>
        <p><strong>Phosphorescence Data Protection Officer</strong><br />
        Samuel Horwitz<br />
        <a href="mailto:data@phosphor.me">data@phosphor.me</a></p>
        <p>This policy is effective as of 17 September 2019.</p>
    </legal>
</template>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Privacy Policy | Phosphorescence',
                meta: [
                    {
                        hid: 'og:type',
                        name: 'og:type',
                    ...
                    },
                    {
                        hid: 'og:description',
                        name: 'og:description',
                        content: 'Privacy policy for users'
                    },
                    {
                        hid: 'og:url',
                        name: 'og:url',
                        content: 'https://phosphor.me/legal/privacy'
                    },
                    {
                        hid: 'og:title',
                        name: 'og:title',
