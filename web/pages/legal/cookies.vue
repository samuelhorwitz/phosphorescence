<template>
    <legal>
        <h2>Cookie Policy</h2>
        <p>We use cookies to help improve your experience of <a href="https://phosphor.me">https://phosphor.me</a>. This cookie policy is part of Phosphorescence's privacy policy, and covers the use of cookies between your device and our site. We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy.</p>
        <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <a href="https://phosphor.me">https://phosphor.me</a>, with the understanding that we may be unable to provide you with some of your desired content and services.</p>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'Cookie Policy | Phosphorescence',
                meta: [
                    {
                        hid: 'og:type',
                        name: 'og:type',
                    ...
                    },
                    {
                        hid: 'og:description',
                        name: 'og:description',
                        content: 'Cookie policy for users'
                    },
                    {
                        hid: 'og:url',
                        name: 'og:url',
                        content: 'https://phosphor.me/legal/cookies'
                    },
                    {
                        hid: 'og:title',
                        name: 'og:title',
